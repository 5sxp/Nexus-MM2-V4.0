...
-- ==============================================================================
-- TEMAS PRÉ-DEFINIDOS (ajustados Branco e Preto)
-- ==============================================================================
local Themes = {
    Original = {
...
-- ==============================================================================
-- NOVAS FUNÇÕES: DISABLE FOOTSTEP E SHOW ROUND TIMER
-- ==============================================================================
...
-- ==============================================================================
-- ATUALIZAÇÃO DO KNIFE SILENT AIM
-- ==============================================================================
RunService.Heartbeat:Connect(function()
...
local function UpdateESP()
    -- Limpa tracers de jogadores que não estão mais visíveis
    for uuid, line in pairs(TracerCache) do
        line.Visible = false
    end
    
    -- Tracers para jogadores
    for _, plr in ipairs(Players:GetPlayers()) do
        if plr ~= LocalPlayer and plr.Character then
...
local ChicoFrame = Instance.new("Frame")
ChicoFrame.Size = UDim2.new(1, -10, 0, 100)
ChicoFrame.Position = UDim2.new(0, 0, 0, 430)
ChicoFrame.BackgroundColor3 = Theme.ItemBG
ChicoFrame.Parent = TabCredits
AddCorner(ChicoFrame, 8)

local ChicoLayout = Instance.new("Frame")
ChicoLayout.Size = UDim2.new(1, 0, 1, 0)
ChicoLayout.BackgroundTransparency = 1
ChicoLayout.Parent = ChicoFrame

local ChicoImage = Instance.new("ImageLabel")
ChicoImage.Size = UDim2.new(0, 60, 0, 60)
ChicoImage.Position = UDim2.new(0, 10, 0.5, -30)
ChicoImage.BackgroundTransparency = 1
ChicoImage.Image = "rbxassetid://102910815987500"
ChicoImage.Parent = ChicoLayout

local ChicoName = Instance.new("TextLabel")
ChicoName.Size = UDim2.new(0.6, 0, 0, 30)
ChicoName.Position = UDim2.new(0, 80, 0.5, -25)
ChicoName.BackgroundTransparency = 1
ChicoName.Text = "ChicoDisigner.xits"
ChicoName.TextColor3 = Theme.Accent
ChicoName.Font = Enum.Font.GothamBlack
ChicoName.TextSize = 14
ChicoName.TextXAlignment = Enum.TextXAlignment.Left
ChicoName.Parent = ChicoLayout

local ChicoBtn = Instance.new("TextButton")
ChicoBtn.Size = UDim2.new(0.3, -10, 0, 25)
ChicoBtn.Position = UDim2.new(0, 80, 0.5, 5)
ChicoBtn.BackgroundColor3 = Theme.Accent
ChicoBtn.Text = "Canal do YouTube"
ChicoBtn.TextColor3 = Color3.new(1, 1, 1)
ChicoBtn.Font = Enum.Font.GothamBold
ChicoBtn.TextSize = 11
ChicoBtn.Parent = ChicoLayout
AddCorner(ChicoBtn, 4)
...
Separator.Position = UDim2.new(0, 10, 0, 540)
